    ...
    <body>
      ...
      <form action="resultado.php" method="post">
		...
		<div class="header"> 
            ...
            <div class="titulo"> 
                <h1>  Qual o unico planeta com vida no Sistema solar? </h1>
             </div>
