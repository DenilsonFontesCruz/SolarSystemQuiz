    ...
    <body>
      ...
      <form action="questao2.php" method="post">
		...
		<div class="header"> 
            ...
            <div class="titulo"> 
                <h1>  Qual é o planeta mais perto do Sol no Sistema solar? </h1>
             </div>
