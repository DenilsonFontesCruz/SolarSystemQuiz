    ...
    <body>
      ...
      <form action="questao5.php" method="post">
		...
		<div class="header"> 
            ...
            <div class="titulo"> 
                <h1>  Qual é o menor planeta do Sistema solar? </h1>
             </div>
