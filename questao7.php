    ...
    <body>
      ...
      <form action="questao8.php" method="post">
		...
		<div class="header"> 
            ...
            <div class="titulo"> 
                <h1>  Qual Planeta possui um cinturão de asteróides no Sistema solar? </h1>
             </div>
