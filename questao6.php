    ...
    <body>
      ...
      <form action="questao7.php" method="post">
		...
		<div class="header"> 
            ...
            <div class="titulo"> 
                <h1>  Qual é o planeta mais quente do Sistema solar? </h1>
             </div>
